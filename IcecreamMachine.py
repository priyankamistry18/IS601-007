...
from IceceamExceptions import (ExceededRemainingChoicesException,
                               InvalidChoiceException, InvalidPaymentException,
...
class Usable:
    ...
    def use(self):
        ...
        try: 
            ...
            print("Your choice item is out of stock. Please choose another available options")
...
class IceCreamMachine:
    ...
    def handle_pay(self, expected, total):
        if total == str(expected):
            print("Thank you so mcuh! Enjoy your icecream!")
            ...
            try: 
                ...
                print("The Amount entered didn't match with the total. Please kindly re-enter")
                self.run()
    ...
    def calculate_cost (self):
        ...
        #cost = container ,costtotal_cost = 0
        cost = 0
